        ...
        <div className="settings-grid">
          <div className="settings-card">
              ...
              <div className="image-upload-wrapper">
                {settings.bannerUrl && (
                  <div className="image-preview">
                    <img
                      src={settings.bannerUrl.startsWith("/") ? `${apiBaseUrl}${settings.bannerUrl}` : settings.bannerUrl}
                      alt="Banner Preview"
                    />
                    <button
                      type="button"
                ...
                <label className="upload-btn">
                  <input type="file" accept="image/*" onChange={(e) => handleFileUpload(e, "bannerUrl")} hidden />
            ...
            <div className="input-group">
              ...
              <textarea name="bannerSubtitle" value={settings.bannerSubtitle} onChange={handleChange} />
            </div>
                ...
                <div className="image-upload-wrapper">
                  {settings.popupImageUrl && (
                    <div className="image-preview">
                      <img
                        src={
                          settings.popupImageUrl.startsWith("/")
                            ? `${apiBaseUrl}${settings.popupImageUrl}`
                            : settings.popupImageUrl
                        }
                        alt="Popup Preview"
                      />
          ...
          <div className="settings-card">
            ...
            <div className="input-group">
              <label>Địa chỉ</label>
              <textarea name="contactAddress" value={settings.contactAddress} onChange={handleChange} />
            </div>
          </div>
        </div>

        <div className="form-actions">
          <button type="submit" className="primary-button save-settings-btn">
      ...
      <style
        dangerouslySetInnerHTML={{
          __html: `
            ...
            .slider { position: absolute; cursor: pointer; inset: 0; background-color: #334155; transition: .4s; }
