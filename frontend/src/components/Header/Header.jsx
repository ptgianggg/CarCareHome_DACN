...
function Header() {
  ...
  const dashboardPath = isAdmin ? "/admin" : isStaff ? "/staff" : null;
  const dashboardLabel = isAdmin ? "Quản trị viên" : "Khu vực nhân viên";
          ...
          <Link to="/" className="header-brand">
            <div className="header-logo">
              <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
                  d="M5 13L3 15V18H21V15L19 13H5Z"
                  stroke="currentColor"
                  strokeWidth="1.5"
                  strokeLinejoin="round"
                />
                <path
                  d="M5 13L7 7H17L19 13"
                  stroke="currentColor"
                  strokeWidth="1.5"
                  strokeLinejoin="round"
                />
